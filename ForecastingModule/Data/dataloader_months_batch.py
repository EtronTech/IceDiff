...
def collate_fn_train(batch):
    ...
    ret = {}
    ret['Input'] = torch.zeros((6,6,448,304),dtype=torch.float32)  # B C H W
    ret['Output'] = torch.zeros((6,6,448,304),dtype=torch.float32)
...
def collate_fn_val(batch):
    ...
    ret = {}
    ret['Input'] = torch.zeros((1,6,448,304),dtype=torch.float32)
    ret['Output'] = torch.zeros((1,6,448,304),dtype=torch.float32)
